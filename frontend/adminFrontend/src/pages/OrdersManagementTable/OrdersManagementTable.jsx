...
const OrdersManagementTable = () => {
  ...
  const { data, dataEmployees, handleLoadEmployeesById } = useOrders();
  ...
  return (
    <div>
      <OrderCard data={data} dataEmployees={dataEmployees} getEmployeesByOrderId={handleLoadEmployeesById}/>
    </div>
  );
};
